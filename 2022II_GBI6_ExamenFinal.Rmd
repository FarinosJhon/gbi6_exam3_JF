...
La gráfica (a) muestra los datos ordenados por el eje "x" como el ancho del pico, el eje "y" como el largo del pico, la coloración para las especies siendo el color azul para Gentoo, verde para Chinstrap y rojo para Adelle, además se dividen en tres columnas separando a las 3 islas donde se tomaron los datos, que son: Biscoe, Dream y Torgersen. Las nubes de puntos muestran que la especie Adelle se ubica en las 3 islas mostrando una correlación positiva marcada (Coeficiente de correlación: 0.2 y 0.27) entre el ancho y largo del pico para las islas Biscoe y Dream, así mismo muestran una correlación positiva no tan marcada en la isla Torgersen (Coeficiente de correlación: 0.03).Por otro lado, la especie Chinstrap únicamente se ubica en la isla Dream y muestran una correlación muy fuerte para los dos parámetros con un coeficiente de correlación de 0.43. Finalmente, la especie Gentoo se ubica en la isla Biscoe y muestra una correlación positiva con un coeficiente de correlación de 0.43. 
Las gráfica b y c, muestran la relación de estas especies entre su longitud y ancho del pico, en cuanto a longitud las especies Chinstrap y Gentoo son mucho mayores a Adelle, sin embargo en cuanto a ancho de pico, las especies Adelle y Chinstrap muestran un pico mucho más ancho que Gentoo, segun la posición de las medias. 
